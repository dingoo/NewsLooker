...
public class NewsListView extends ListView implements OnScrollListener {
    ...
    private void init(Context context) {
        ...
        */
        ...
        /*
            上拉加载
        */
        mLoadView= (RelativeLayout) mInflater.inflate(R.layout.loadmore,this,false);
        mLoadMoreText= (TextView) mLoadView.findViewById(R.id.loading_text);
        mLoadMoreProgress= (ProgressBar) mLoadView.findViewById(R.id.footer_loading);
    ...
    public interface OnRefreshListener {
         ...
         * <p>
         * A call to {@link NewsListView #onRefreshComplete()} is
    ...
    public interface OnLoadMoreListener {
         ...
         * {@link NewsListView #onLoadMoreComplete()} is expected to
