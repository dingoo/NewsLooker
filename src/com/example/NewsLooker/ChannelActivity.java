...
import com.example.NewsLooker.adapter.DragAdapter;
import com.example.NewsLooker.adapter.OtherAdapter;
...
import com.example.NewsLooker.view.DragGrid;
import com.example.NewsLooker.view.OtherGridView;
...
public class ChannelActivity extends BaseActivity implements OnItemClickListener {
    ...
    public void onBackPressed() {
        ...
        if(userAdapter.isListChanged()){
            ...
            setResult(MainNewsActivity.CHANNELRESULT, intent);
            finish();
            Log.d(TAG, "数据发生改变");
        }else{
            super.onBackPressed();
